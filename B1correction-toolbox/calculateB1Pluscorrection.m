function [corrFact_1, corrFact_2,corr_field, B1_tx_corrected, maskGoodness] = calculateB1Pluscorrection(img_ori,T1map,polyModel7,FAmap,mask,plotFlag)
...
% for B1+ inhomogeneities only and it is used in the hybrid correction
%
%
